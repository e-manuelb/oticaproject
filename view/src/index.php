...
<body>
    <div class="container-scroller">
        ...
        <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <button type="button" class="btn btn-primary toolbar-item" onclick="window.location.href = 'pages/samples/login.php'">Sair</button>
                </form>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="pages/forms/cadastrouser.php">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="pages/forms/cadastrogrp.php">
                            <i class="menu-icon typcn typcn-shopping-bag"></i>
                            <span class="menu-title">Cadastro de grupo/subgrupo</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="pages/forms/cadastrotipo.php">
                            <i class="menu-icon typcn typcn-th-large-outline"></i>
                            <span class="menu-title">Cadastro de tipo</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="pages/forms/cadastrofor.php">
